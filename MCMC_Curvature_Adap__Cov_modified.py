...
h_values_final = np.hstack((adap_cov_h_values1[length_adap_cov2-500:length_adap_cov2],adap_cov_h_values2[length_adap_cov2-500:length_adap_cov2],adap_cov_h_values3[length_adap_cov2-500:length_adap_cov2],adap_cov_h_values4[length_adap_cov2-500:length_adap_cov2]))
...
figure1 = corner.corner(data, bins = 30, levels = levels, smooth = 1.0, smooth1d = 1.0, show_titles = True, \
                        labels = [r"$\Omega_m$",r"$\Omega_{\Lambda}$","h"],range = [[0.1,0.5],[0.5,0.85],[0.55,0.85]],\
                        label_kwargs = dict(size = '18'),title_kwargs = dict(size='18'),fill_contours = True,\
                        quantiles = [0.158656,0.841344],truths = [omega_m_max,omega_v_max,h_max])
